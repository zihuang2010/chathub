---
name: cluster-6
description: "Skill for the Cluster_6 area of chathub. 62 symbols across 4 files."
---

# Cluster_6

62 symbols | 4 files | Cohesion: 90%
...
| File                                                   | Symbols                                                                   |
| ------------------------------------------------------ | ------------------------------------------------------------------------- |
| `backends/crates/chathub-state/src/recent_sessions.rs` | new, list_top, upsert_remote_many, upsert_remote_one, apply_summary (+53) |
...
| `set_pinned`                            | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 320  |
| `set_muted`                             | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 346  |
| `set_removed`                           | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 400  |
| `set_draft`                             | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 433  |
| `set_draft_at`                          | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 460  |
| `trim`                                  | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 509  |
| `trim_to_max`                           | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 566  |
| `advance_watermark`                     | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 571  |
| `clear_for_employee`                    | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 627  |
| `in_memory_pool_supports_repeated_open` | Function | `backends/crates/chathub-state/src/pool.rs`            | 113  |
| `now_unix_ms`                           | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 757  |
| `sample_remote`                         | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 772  |
| `sample_remote_for`                     | Function | `backends/crates/chathub-state/src/recent_sessions.rs` | 776  |
...
| `Draft_lifts_row_above_newer_message → RecentSessionRemote`                        | intra_community | 4     |
