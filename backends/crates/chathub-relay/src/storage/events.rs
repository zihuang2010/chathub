//! events 表:
//!   - 旧 `EventStore`(ring buffer,wecom_account 维度):legacy,push/hub 切到新 API 后清理
//!   - 新 `EventLog`(employee_id 维度,带完整 batch 字段):重构后的事件日志
...
// ─────────────────────────────────────────────────────────────────────────
// EventLog —— 新事件日志(employee_id + notify_seq + event_index 主键)
// ─────────────────────────────────────────────────────────────────────────
